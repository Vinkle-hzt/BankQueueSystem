...
const char *mysql_host = "localhost";       ///< mysql host 地址
const char *mysql_user = "root";            ///< mysql 用户名
const char *mysql_pwd = "15868372516";      ///< mysql 密码
const char *mysql_db = "bank_queue_system"; ///< mysql 数据库名称
int mysql_connect_port = 3306;              ///< mysql 数据库端口号
